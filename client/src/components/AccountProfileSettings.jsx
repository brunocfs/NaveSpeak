...
// Seções de "Foto de perfil" / "Informações do perfil" / "Alterar senha" -
// extraídas de ProfilePage.jsx pra reusar dentro da aba "Conta e Perfil" do
// PreferencesModal.jsx, sem duplicar toda a lógica de upload de avatar/
// validação/troca de senha. ProfilePage.jsx continua existindo (rota própria,
// com header e link "Voltar"), só que agora só monta este componente dentro
